  ...
  return (
    <div className="min-h-screen bg-gray-200 w-full">
      <div className="container mx-auto px-4 py-8">
        <PageRenderer pages={pages} selectedPage={selectedPage} setSelectedPage={setSelectedPage} setSelectedBlock={setSelectedBlock} handleDeleteBlock={handleDeleteBlock} confirmDeleteBlock={confirmDeleteBlock} setOpen={setOpen} blocks={[]} />
